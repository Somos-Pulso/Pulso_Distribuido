...
| **Médico**           | Profissional da linha de frente, envolvido diretamente nos plantões e atendimentos, com rotina dinâmica e jornadas intensas. | - Consultar escalas atualizadas em tempo real;<br>- Solicitar trocas de plantão ou ajustes de horário;<br>- Comunicar-se com gestores e colegas sobre disponibilidades;<br>- Confirmar presença em plantões designados. |  
...
Já os médicos, buscam principalmente autonomia, clareza e organização no gerenciamento de suas rotinas de trabalho. Suas necessidades incluem o acesso rápido e intuitivo às escalas de plantão por meio de calendários interativos, a facilidade para solicitar ou negociar trocas de turno com colegas e a transparência no controle da jornada de trabalho, com registros de ponto e acompanhamento do banco de horas. A comunicação eficiente com a gestão é indispensável, especialmente para receber notificações sobre mudanças na escala ou aprovações de solicitações. Além disso, os profissionais valorizam a possibilidade de registrar preferências de horário e indicar indisponibilidades, o que torna a escala mais personalizada e respeitosa com sua realidade. Muitos também atuam em múltiplas instituições, o que reforça a necessidade de uma agenda pessoal integrada para evitar sobreposição de plantões. Recursos para registrar anotações pessoais ou compartilhar informações operacionais completam o conjunto de demandas que tornam a experiência mais funcional e humanizada.
...
Para os gestores, o sistema oferece recursos como a criação e edição de escalas, controle do banco de horas, substituições emergenciais, análise de performance e tomada de decisão. Também estão disponíveis ferramentas de comunicação como notificações e suporte para reuniões remotas. Esses recursos permitem uma administração proativa, ágil e transparente.
Já os médicos contam com um ambiente digital que centraliza sua agenda de plantões, notificações em tempo real, pedidos e aceite de trocas, registro de ponto, acompanhamento de carga horária e banco de horas, além da possibilidade de indicar preferências e organizar plantões externos. Tal módulo promove autonomia e organização pessoal, respeitando preferências individuais e proporcionando maior equilíbrio entre vida profissional e pessoal.
